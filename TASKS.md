...
- [x] remove the word “Expert” from the hero image text overlay.
- [x] Just below, remove the last sentence, “From tenant relations to maintenance, we handle it all,” and leave only the sentence about maximizing potential.

### Property Maintenance & Operations card, Commercial Property Management Services section

- [x] Vendor & Project Oversight bullet: edit to “manage vendor contracts, schedule work, and oversee capital improvements…” so the verbs are all in the same tense
- [x] Same section, end sentence: change it to “With our proactive tenant relations approach, your property becomes a place where businesses want to stay, thrive, and succeed!”
- [x] CTA for this section: update it to “Ensure your property is managed efficiently and well-maintained 24/7”?
