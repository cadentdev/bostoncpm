...
- [ ] remove the word “Expert” from the hero image text overlay.
- [ ] Just below, remove the last sentence, “From tenant relations to maintenance, we handle it all,” and leave only the sentence about maximizing potential.

### Property Maintenance & Operations card, Commercial Property Management Services section

- [ ] Vendor & Project Oversight bullet: edit to “manage vendor contracts, schedule work, and oversee capital improvements…” so the verbs are all in the same tense
- [ ] Same section, end sentence: change it to “With our proactive tenant relations approach, your property becomes a place where businesses want to stay, thrive, and succeed!”
- [ ] CTA for this section: update it to “Ensure your property is managed efficiently and well-maintained 24/7”?
